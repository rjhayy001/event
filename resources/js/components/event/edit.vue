            ...
            <v-layout row wrap>
                                    ...
                                    <v-layout row >
                                        <v-flex xs7>
                                           <v-btn small color="success" class="float-right" dense @click="open_map">
                                                <v-icon left>mdi-map-check-outline</v-icon> Gérer la plan
                                            </v-btn>
                ...
                <v-flex xs6 sm3>
                    <v-card class="pa-3">
                        ...
                        <v-list-item >
                            <v-list-item-content>
                            <v-list-item-title class="text-capitalize font-weight-bold primary--text " >{{event2.name ? event2.name:'Non défini '}}</v-list-item-title>
